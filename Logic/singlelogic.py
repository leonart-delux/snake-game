...
class SinglePlayerGameLogic(BaseGameLogic):
    ...
    def handle_lose(self, text):
        ...
        while self.game_over and running_noti:
            self.ui.display_button((self.ui.width // 4, self.ui.height // (10/4)), (self.ui.width // 2, self.ui.height // 10), text, self.ui.text_font, self.ui.white, self.ui.red, radius=10)
